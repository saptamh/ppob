...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Bonus</h1>
    @can('bonus-create')
    <div class="row">
        <div class="col-lg-12">
            <a href="{{ route('bonus.add') }}" class="btn btn-primary btn-circle">
...
$(document).ready(function() {
    ...
    $('#DataTable tbody').on('click', '#edit_btn', function () {
        ...
        window.location.href = baseUrl + "/bonus/edit/" + data_row.id;
    });
    ...
    $('#DataTable tbody').on('click', '#remove_btn', function () {
        ...
        if (c) {
            ...
            $.ajax({
                url: baseUrl + "/bonus/destroy/" + data_row.id,
                method: 'delete',
