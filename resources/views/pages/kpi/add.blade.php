    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                {{ Form::select('employee_id', $select_box['employees'], '', ['class'=>'form-control ', 'placeholder'=>'Select Employee', 'required'=>'true']) }}
            </div>
            <div class="form-group">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                {{ Form::number('job_percentage', '', ['class'=>'form-control ', 'placeholder'=>'Enter Work', 'required'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('quality_percentage', 'Quality') }}
                {{ Form::number('quality_percentage', '', ['class'=>'form-control ', 'placeholder'=>'Enter Quality', 'required'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('attitude_percentage', 'Attitude') }}
                {{ Form::number('attitude_percentage', '', ['class'=>'form-control ', 'placeholder'=>'Enter Attitude', 'required'=>'true']) }}
            </div>
        </div>
    </div>
    <div class="row">
