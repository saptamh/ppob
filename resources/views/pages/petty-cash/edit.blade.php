    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                {{ Form::select('budget_for', array_combine($select_box['budget'], $select_box['budget']), $edit['budget_for'], ['class'=>'form-control', 'placeholder'=>'Select Budget For', 'required'=>'true']) }}
            </div>
            ...
            <div class="form-group">
                ...
                {{ Form::text('noted_news', $edit['noted_news'], ['class'=>'form-control', 'placeholder'=>'Enter Noted News', 'required'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('name_bank_from', 'From Bank') }}
                {{ Form::text('name_bank_from', $edit['name_bank_from'], ['class'=>'form-control', 'placeholder'=>'Enter Name Bank', 'required'=>'true']) }}
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                {{ Form::label('name_bank_to', 'To Bank') }}
                {{ Form::text('name_bank_to', $edit['name_bank_to'], ['class'=>'form-control', 'placeholder'=>'Enter Name Bank', 'required'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('type', 'Type') }}
                {{ Form::select('type', array_combine($select_box['type'], $select_box['type']), $edit['type'], ['class'=>'form-control', 'placeholder'=>'Select Type', 'required'=>'true']) }}
            </div>
            <div class="form-group">
