...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="h3 mb-2 text-gray-800">Edit Project Daily</h1>
                @if ($errors->any())
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                {{ Form::text('date', $edit->date, ['class'=>'form-control', 'placeholder'=>'Enter Date', 'required'=>'true', 'readonly'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('employee_id', 'PIC') }}
                {{ Form::select('employee_id', $select_box['employee'], $edit->employee_id, ['class'=>'form-control', 'placeholder'=>'Select PIC']) }}
            </div>
            <div class="form-group">
                {{ Form::label('job', 'Job') }}
                {{ Form::text('job', $edit->job, ['class'=>'form-control', 'placeholder'=>'Enter Job', 'required'=>'true', 'readonly'=>'true']) }}
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                {{ Form::label('target', 'Target') }}
                {{ Form::number('target', $edit->target, ['class'=>'form-control', 'placeholder'=>'Enter Target', 'required'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('worked_hour', 'Worked Hour') }}
                {{ Form::number('worked_hour', $edit->worked_hour, ['class'=>'form-control', 'placeholder'=>'Enter Worked Hour', 'required'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('realisation', 'Realisation') }}
                {{ Form::number('realisation', $edit->realisation, ['class'=>'form-control', 'placeholder'=>'Enter Realisation', 'required'=>'true']) }}
            </div>
            <div class="form-group">
