...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="h3 mb-2 text-gray-800">Edit Project Timeline</h1>
                @if ($errors->any())
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                {{ Form::select('projects_id', $select_box['projects'], $edit->projects_id, ['class'=>'form-control', 'placeholder'=>'Select Project', 'required'=>'true']) }}
            </div>
            <div class="form-group">
                {{ Form::label('manager_id', 'Project Manager') }}
                {{ Form::select('manager_id', $select_box['manager'], $edit['manager_id'], ['class'=>'form-control', 'placeholder'=>'Select Manager']) }}
            </div>
            <div class="form-group">
                {{ Form::label('type', 'Type') }}
                {{ Form::select('type', array_combine($select_box['type'], $select_box['type']), $edit->type, ['class'=>'form-control', 'placeholder'=>'Select Type']) }}
            </div>
            <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                {{ Form::number('qty', $edit['qty'], ['class'=>'form-control', 'placeholder'=>'Enter Quantity', 'required'=>'true']) }}
            </div>
            <div class="form-group">
