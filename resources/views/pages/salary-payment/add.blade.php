    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="form-row">
                    <div class="col">
                        {{ Form::text('work_day', '0', ['class'=>'form-control calculate-salary', 'readonly'=>'true', 'placeholder'=>'Enter Work Day', 'required'=>'true']) }}
                    </div>
                    <div class="col">
            ...
            <div class="form-group">
                ...
                <div class="form-row">
                    <div class="col">
                        {{ Form::text('over_time_day', '0', ['class'=>'form-control calculate-salary', 'readonly'=>'true', 'placeholder'=>'Enter Over Time (day)', 'required'=>'true']) }}
                    </div>
                    <div class="col">
            ...
            <div class="form-group">
                ...
                <div class="form-row">
                    <div class="col">
                        {{ Form::text('over_time_hour', '0', ['class'=>'form-control calculate-salary', 'readonly'=>'true', 'placeholder'=>'Enter Over Time (hour)', 'required'=>'true']) }}
                    </div>
                    <div class="col">
            ...
            <div class="form-group">
                ...
                <div class="form-row">
                    <div class="col">
                        {{ Form::text('meal_allowance', '0', ['class'=>'form-control calculate-salary', 'readonly'=>'true', 'placeholder'=>'Enter Meal Allowance', 'required'=>'true']) }}
                    </div>
                    <div class="col">
            ...
            <div class="form-group">
                ...
                {{ Form::text('bonus', '0', ['class'=>'form-control calculate-salary', 'readonly'=>'true', 'placeholder'=>'Enter Bonus', 'required'=>'true']) }}
            </div>
            <div class="form-group">
...
@include('pages.salary-payment/periode-template')
